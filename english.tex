...
\item \textbf{Cloud Software Engineer} (October 2018 -- present)\\
  ...
  Clear Linux reference stacks. Leo is the integration architect and
  has lead
  \href{https://github.com/intel/stacks/tree/master/dars}{DARS}
  (Data Analytic Reference Stack) and \href{https://github.com/intel/stacks/tree/master/mers}{MERS}
  (Media Analytic Reference Stack).
\end{itemize}
