...
\begin{category}{Work \\experience}
  ...
  \item \textbf{Senior Software Engineer - CodeLinaro} (Apr 23 -- Aug 23)\\
    Part of the core \href{www.codelinaro.org}{Codelinaro} team, leading the Git and CI/CD repository migration
    from \href{git.linaro.org}{Linaro Git}/\href{ci.linaro.org}{Linaro Jenkins} to
    \href{git.codelinaro.org}{CodeLinaro Git}, providing migration tools, documentation and support to internal Developer Services teams.
  \end{itemize}

  \begin{itemize}
  \item \textbf{Senior Software Engineer - Qualcomm Landing} (Jan 22 -- April 23)\\
    Part of the Qualcomm Landing Team CI team, leading the CI/CD Migration from \href{https://ci.linaro.org/view/qclt/}{Linaro Qualcomm Jenkins} into
  ...
  \item \textbf{Senior Software Engineer - MbedTLS} (Oct 21 -- Jan 22)\\
    Lead the CI migration from ARM internal Jenkins instance into a public \href{https://github.com/ARMmbed/mbedtls}{Mbed TLS}.
  \end{itemize}

  \begin{itemize}
  \item \textbf{Senior Software Engineer - Trusted Firmware-A} (May 20 -- Jan 22)\\
    Lead the CI migration of the \href{https://www.trustedfirmware.org/projects/tf-a/}{TF-A}
    project from an ARM internal Jenkins instance into a public instance \href{https://ci.trustedfirmware.org/}{TF-A CI}.
  ...
  \item \textbf{Integration Architect - Intel Stacks} (Oct 18 -- May 20)\\
    ...
    Leading two stacks as integration architect leading:
