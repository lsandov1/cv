...
\item \textbf{Software Engineer} (October 2018 -- present)\\
  ...
  Clear Linux reference Docker Images. Leo is the tech lead and architect of
  the \textbf{Data Analytic Reference Stack}. Docker files can be found at
  \href{https://github.com/clearlinux/dockerfiles/tree/master/stacks/dars}{Data
