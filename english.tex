...
\item \textbf{Software Engineer} (October 2018 -- present)\\
  ...
  Clear Linux reference Docker Images. Leo is currently the Architect of
  \href{https://github.com/clearlinux/dockerfiles/tree/master/stacks/dars}{DARS}
  (Data Analytic Reference Stack).
\end{itemize}
