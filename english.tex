...
\item \textbf{Professional Services Consulter} (April 2014 -- February 2015)\\
  Board Support Package (BSP) development and support for \texttt{i.MX} custom
  boards. Design and develop user-space (multimedia) applications for the \texttt{i.MX}
  processors.
\end{itemize}
...
\item \textbf{Field Application Engineer} (July 2012 -- April 2014)\\
  ...
  \texttt{i.MX} Applications Processors, with main focus on issues raised from software
