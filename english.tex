...
\item \textbf{Software Engineer} (December 2017 -- October 2018)\\
  ...
  Linux team. Leo's contributions focused on optimizations on string routines in the \textit{GNU
    C library}, using SIMD AVX2 technology for \textit{strcmp} and
  \textit{strcpy} routines. Leo's contribution to the latter project can be found at
